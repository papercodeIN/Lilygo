...
// Reserve pin 16 for NeoPixel ground (per user request). Use pin 15 as the
// NeoPixel data/control pin. If your board wiring differs, change these.
#define NEOPIXEL_GND_PIN (16)
